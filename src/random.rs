...
impl RandomState {
    ...
    /// Refetch all album_ids, shuffle them, and replace the internal state.
    /// Returns the new length.
    pub fn reshuffle(&self, conn: &Connection) -> Result<usize> {
